    ...
    <div>
      <div className='w-[98dvw] mx-auto max-w-[1200px] pb-[200px]'>
        <section className='first-section w-full h-[330dvh] relative overflow-hidden'>
          ...
          <img src={roseRight} alt="" className="z-10 absolute top-[250px] left-[-20%] w-[50%] " />
          <img src={roseLeft} alt="" className="z-10 absolute top-[250px] right-[-20%] w-[50%]" />
          <img src={vinesflip} alt="" className="z-9 absolute top-[250px] left-[-5%] w-[50%] " />
          <img src={vines} alt="" className="z-9 absolute top-[250px] right-[-5%] w-[50%]" />
          ...
          <img src={castleCloud} alt="" className="z-20  w-[60%] top-[910px] absolute left-[18%]" />
          <img src={baloon} alt="" className="z-7  w-[55%] top-[600px] absolute left-[5%]" />
          <img src={tree2} alt="" className="z-4 h-[80%] absolute bottom-0 -left-[54%]" />
          <img src={tree1} alt="" className="z-4 h-[70%] absolute bottom-0 -right-[52%]" />
          <div className="z-3 w-[120%] absolute bottom-[-10%] left-1/2 -translate-x-1/2">
